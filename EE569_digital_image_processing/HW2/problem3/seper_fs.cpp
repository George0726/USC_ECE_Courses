...

{
	...
	error_diffusion_FS_color(image_input,image_ouput,Width,Height,BytesPerPixel);
	// error_diffusion_FS_color_test(image_input,image_ouput,Width,Height,BytesPerPixel);
