function M = step1_skeleton(img,bond)
    [m,n] = size(img);
    M = zeros(m,n);
    for i=1:m
        for j=1:n
...
%                           img(i,j) == bin2dec('01110100') || ...
                      M(i,j) = img(i,j) == bin2dec('11101000') || ...
                ...
                case 11
                    M(i,j) = img(i,j) == bin2dec('11111011')||...
                        img(i,j) == bin2dec('11111110')||...
                        img(i,j) == bin2dec('11011111')||...
                        img(i,j) == bin2dec('01111111');
                otherwise
                    M(i,j) = 0;
            end
        end
