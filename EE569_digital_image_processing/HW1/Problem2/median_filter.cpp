...

{
	...
	if (argc < 4){
			...
			cout << "program_name input_image.raw output_image.raw ground_truth.raw [kernel_size = 3]  [Width = 500] [Height = 400] [BytesPerpixel = 3]" << endl;
			return 0;
	}
	...
	median_filter(image_input,image_output,kernel_size,Width,Height,BytesPerPixel);
	...
	for(int k = 0; k < BytesPerPixel; k++){
		cout<<"Before Denoise PSNR: "<<p_in[k]<<"  "<<"After Denoise PSNR: "<<p_out[k]<<endl;
	}
